...
<body>
    ...
    <div class="bg-transparent">
            ...
            <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
                <div class="flex lg:flex-1">
                    <a href="login.php" class="-m-1.5 p-1.5">
                        <h2 style="color: var(--hightlight-color); font-weight: bold;"><i class="bi bi-wallet2 me-2"></i>Nyawit Track</h2>
                    </a>
                </div>
                ...
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="login.php" class="text-sm/6 font-bold text-gray-900">Log in <span
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl pt-10 pb-32 sm:pt-16 sm:pb-48 lg:pt-20 lg:pb-56">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    
                </div>
                <div class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Take Control of Your Every Penny</h1>
                    <p class="mt-8 text-lg font-medium text-pretty text-white sm:text-xl/8">
    Track your daily expenses and manage your personal budget effortlessly. Your financial freedom starts with a single click.
</p>
